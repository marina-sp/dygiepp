...
class MultiTaskAdjacencyField(Field[torch.Tensor]):
    """
    ...
    def __init__(
        ...
        self.annotated_predicates = annotated_predicates
    ...
    def as_tensor(self, padding_lengths: Dict[str, int]) -> torch.Tensor:
        ...
        tensor = torch.ones(desired_num_tokens, desired_num_tokens, self.vocab_size) * self._padding_value
    ...
    @overrides
    def empty_field(self) -> "MultiTaskAdjacencyField":

        # The empty_list here is needed for mypy
        empty_list: List[Tuple[int, int]] = []
        adjacency_field = MultiTaskAdjacencyField(
    ...
    def __str__(self) -> str:
        ...
        return (
            f"MultiTaskAdjacencyField of length {length}\n"
            f"\t\twith indices:\n {formatted_indices}\n"
